export const badges = [
  { id: 'streak_7', label: '7-Day Streak', days: 7, icon: 'flame' },
  { id: 'streak_30', label: '30-Day Streak', days: 30, icon: 'bolt' },
  { id: 'streak_100', label: '100-Day Streak', days: 100, icon: 'trophy' },
  { id: 'streak_365', label: '365-Day Streak', days: 365, icon: 'crown' },
  { id: 'first_log', label: 'First Log', days: 1, icon: 'star' },
];

// Canonical milestone list — shared with BadgeScreen
